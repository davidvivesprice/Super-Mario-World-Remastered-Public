...
var primary_actions = [preload("res://Resources/Inputs/dive.tres"), preload("res://Resources/Inputs/jump.tres"), preload("res://Resources/Inputs/move_down_stick.tres"), preload("res://Resources/Inputs/move_left_stick.tres"), preload("res://Resources/Inputs/move_right_stick.tres"), preload("res://Resources/Inputs/move_up_stick.tres"), preload("res://Resources/Inputs/run.tres"), preload("res://Resources/Inputs/spin_jump.tres"), preload("res://Resources/Inputs/slowmo_enemy.tres"), preload("res://Resources/Inputs/slowmo_world.tres")]
var primary_strings = ["dive", "jump", "move_down", "move_left", "move_right", "move_up", "run", "spin_jump", "slowmo_enemy", "slowmo_world"]

var secondary_actions = [preload("res://Resources/Inputs/move_down_pad.tres"), preload("res://Resources/Inputs/move_left_pad.tres"), preload("res://Resources/Inputs/move_right_pad.tres"), preload("res://Resources/Inputs/move_up_pad.tres"), preload("res://Resources/Inputs/jump_2.tres")]
var secondary_strings = ["move_down", "move_left", "move_right", "move_up", "jump"]
